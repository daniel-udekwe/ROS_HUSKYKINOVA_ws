...
class messageConverter:
    ...
    def __init__(self):
    	...
    	self.Twist_sub = rospy.Subscriber("/my_gen3/in/cartesian_velocity_mod", Twist, self.twist_callback)
    	self.TwistCommand_pub = rospy.Publisher("/my_gen3/in/cartesian_velocity", TwistCommand, queue_size=1)
    	rospy.spin()
